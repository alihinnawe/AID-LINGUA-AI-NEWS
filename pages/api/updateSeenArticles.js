...
export default async function handler(req, res) {
  ...
  try {
    ...
    const updatedSeenArticle = await Article.findByIdAndUpdate(
      articleId,
      {
        $inc: { seen: increment }, // Increment or decrement 'likes' based on the increment value
      },
      {
